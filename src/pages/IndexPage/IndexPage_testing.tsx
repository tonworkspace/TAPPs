...
// import DailyNewsPopup from '@/components/DailyNewsPopup';
// import StakingBenefitsModal from '@/components/StakingBenefitsModal';
...
//   const [showDailyNewsPopup, setShowDailyNewsPopup] = useState(false);
//   const [showStakingBenefitsModal, setShowStakingBenefitsModal] = useState(false);
//   const [showCommunityJoinModal, setShowCommunityJoinModal] = useState(false);
...
//   // Show daily news popup for non-staked users
//   useEffect(() => {
//     if (user && Number(user.balance ?? 0) === 0) {
//       // Show popup after 3 seconds for non-staked users
//       const timer = setTimeout(() => {
//         setShowDailyNewsPopup(true);
//       }, 3000);
...
//             {/* Show engagement components for non-staked users */}
...
//         {/* Engagement Modals for Non-Staked Users */}
//         <DailyNewsPopup
//           isOpen={showDailyNewsPopup}
//           onClose={() => setShowDailyNewsPopup(false)}
//           userBalance={Number(user?.balance ?? 0)}
//           isStaked={Number(user?.balance ?? 0) > 0}
//           onStartStaking={() => setShowDepositModal(true)}
//           onJoinCommunity={() => setShowCommunityJoinModal(true)}
//         />

//         <StakingBenefitsModal
//           isOpen={showStakingBenefitsModal}
//           onClose={() => setShowStakingBenefitsModal(false)}
//           userBalance={Number(user?.balance ?? 0)}
//           onStartStaking={() => setShowDepositModal(true)}
//         />

//         <CommunityJoinModal
//           isOpen={showCommunityJoinModal}
//           onClose={() => setShowCommunityJoinModal(false)}
//           onJoinTelegram={() => {
//             window.open('https://t.me/Tapps_chat', '_blank');
//             setShowCommunityJoinModal(false);
//           }}
//           onFollowTwitter={() => {
//             window.open('https://twitter.com/TAPPsToken', '_blank');
//             setShowCommunityJoinModal(false);
//           }}
//           onJoinDiscord={() => {
//             window.open('https://discord.gg/tapps', '_blank');
//             setShowCommunityJoinModal(false);
//           }}
//         />
//       </div>
