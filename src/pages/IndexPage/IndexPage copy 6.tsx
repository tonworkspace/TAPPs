...
// const EARNINGS_STORAGE_KEY = 'earnings_state';
...
// const NOVA_LEVELS = [
//   { threshold: 0, name: "Nova Recruit", color: "text-gray-400", bonus: "1% ROI Boost" },
//   { threshold: 1000, name: "Nova Initiate", color: "text-blue-400", bonus: "2% ROI Boost" },
//   { threshold: 10000, name: "Nova Explorer", color: "text-green-400", bonus: "3% ROI Boost" },
//   { threshold: 50000, name: "Nova Voyager", color: "text-yellow-400", bonus: "5% ROI Boost" },
//   { threshold: 100000, name: "Nova Guardian", color: "text-orange-400", bonus: "7% ROI Boost" },
//   { threshold: 500000, name: "Nova Sentinel", color: "text-red-400", bonus: "10% ROI Boost" },
//   { threshold: 1000000, name: "Nova Sovereign", color: "text-purple-400", bonus: "12% ROI Boost" },
//   { threshold: 5000000, name: "Nova Legend", color: "text-pink-400", bonus: "15% ROI Boost" },
//   { threshold: 10000000, name: "Nova Immortal", color: "text-gradient-to-r from-yellow-400 via-red-400 to-purple-400", bonus: "20% ROI Boost" }
// ];
...
//       description: `Successfully added ${amount} TON to your stake`
//     });
...
//   // Update the main return statement with new game-like UI
//   return (
//     <div className="flex flex-col min-h-screen bg-black text-white">
//       {/* Header */}
//       <div className="p-4">
//         <div className="flex justify-between items-center mb-4">
//           <button className="text-white/80 text-sm flex items-center gap-2">
...
//           className="w-full bg-blue-500 text-white py-2 rounded-md mb-8"
//         >
//           Connect wallet
//         </button>
//       </div>
...
//         {/* Paw Logo with Mining Animation */}
//         <div className="mb-4 relative">
//           <div className="absolute inset-0 bg-blue-500/10 rounded-full animate-pulse"></div>
//           <svg className="w-16 h-16 text-white relative" viewBox="0 0 24 24" fill="currentColor">
...
//         {/* PAWS Counter with Live Updates */}
//         <div className="text-center mb-6">
//           <div className="relative">
//             <h1 className="text-4xl font-bold mb-2">
//               {(earningState.currentEarnings || 0).toFixed(8)} NOVA
//             </h1>
//             {/* Earning Rate Indicator */}
//             {earningState.isActive && (
//               <div className="absolute -top-4 right-0 text-xs text-green-400 animate-float-up">
//                 +{(earningState.baseEarningRate).toFixed(8)}/s
//               </div>
//             )}
//           </div>
...
//   {/* Balance Card */}
//   <div className="bg-gradient-to-r from-zinc-900/50 to-zinc-800/30 rounded-xl p-5 border border-white/5">
...
//       </div>
//       <div>
//         <div className="text-sm text-white/60">Staked Balance</div>
//         <div className="flex items-center gap-2">
//           <span className="text-xl font-bold text-white">{user?.balance?.toFixed(2)} TON</span>
...
//         style={{ width: `${Math.min((user?.balance || 0) / 1000 * 100, 100)}%` }}
//       />
//     </div>
//   </div>
...
//       </div>
//       <div>
//         <div className="text-sm text-white/60">Novator Power</div>
//         <div className="flex items-center gap-2">
//           <span className="text-xl font-bold text-purple-400">{(user?.total_sbt || 0).toFixed(2)}</span>
//           <span className="text-sm text-purple-400/60">NOVA</span>
//         </div>
//       </div>
//     </div>
...
//           style={{ 
//             width: `${Math.min((user?.total_sbt || 0) / NOVA_LEVELS[1].threshold * 100, 100)}%` 
//           }}
//         />
//       </div>
//       <div className="flex justify-between text-xs">
//         <span className="text-white/40">Level {NOVA_LEVELS.findIndex(level => (user?.total_sbt || 0) < level.threshold)}</span>
//         <span className="text-purple-400/60">
//           {Math.min((user?.total_sbt || 0) / NOVA_LEVELS[1].threshold * 100, 100).toFixed(1)}%
//         </span>
//       </div>
//     </div>
//   </div>
...
//             className="w-full bg-zinc-900 text-white py-3 px-4 rounded-md flex items-center justify-between"
//           >
...
//             disabled={isClaimingEarnings || earningState.currentEarnings < 0.1}
//             className={`w-full py-3 px-4 rounded-md flex items-center justify-between ${
//               isClaimingEarnings || earningState.currentEarnings < 0.1
//                 ? 'bg-zinc-900/50 text-white/40'
...
//           {/* Community Button */}
//           <button className="w-full bg-zinc-900 text-white py-3 px-4 rounded-md flex items-center justify-between">
//             <div className="flex items-center gap-3">
//               <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
//               <div className="relative w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-500 rounded-lg flex items-center justify-center">
...
//             </div>
//             <div>
//               <h3 className="text-lg font-bold text-white">NOVA Levels</h3>
//               <p className="text-sm text-blue-400">Your journey to greatness</p>
//             </div>
//           </div>
//           <button 
...
//         {/* Level List */}
//         <div className="space-y-3">
//           {NOVA_LEVELS.map((level, index) => {
//             const userNova = user?.total_sbt || 0;
//             const isCurrentLevel = userNova >= level.threshold && 
//               (index === NOVA_LEVELS.length - 1 || userNova < NOVA_LEVELS[index + 1].threshold);
//             const isUnlocked = userNova >= level.threshold;
...
//                       isUnlocked ? level.color : 'text-gray-600'
//                     }`}>
//                       {isUnlocked ? '✨' : '🔒'}
//                     </div>
...
//                         {level.name}
//                       </div>
//                       <div className={`text-xs ${isUnlocked ? 'text-blue-400' : 'text-gray-600'}`}>
//                         {level.bonus}
//                       </div>
//                     </div>
//                   </div>
...
//                   {/* Threshold */}
//                   <div className={`text-sm ${isUnlocked ? 'text-green-400' : 'text-gray-600'}`}>
//                     {level.threshold.toLocaleString()} NOVA
//                   </div>
//                 </div>

//                 {/* Progress Bar (only show for current level) */}
//                 {isCurrentLevel && index < NOVA_LEVELS.length - 1 && (
...
//                         style={{ 
//                           width: `${Math.min(
//                             ((userNova - level.threshold) / 
//                             (NOVA_LEVELS[index + 1].threshold - level.threshold)) * 100, 
//                             100
//                           )}%` 
//                         }}
//                       />
...
//                       <span>Progress to {NOVA_LEVELS[index + 1].name}</span>
//                       <span>{Math.min(
//                         ((userNova - level.threshold) / 
//                         (NOVA_LEVELS[index + 1].threshold - level.threshold)) * 100,
//                         100
...
//           Keep staking to unlock more levels and rewards!
//         </div>
//       </div>
//     </div>
//   </div>
...
//                 {user?.balance && user.balance > 0 ? 'Power Up Your Stake!' : 'Start Your Journey!'}
//               </h3>
//               <p className="text-sm text-blue-400">
//                 {user?.balance && user.balance > 0 ? 'Increase your earning power' : 'Begin earning passive income'}
//               </p>
//             </div>
//           </div>
//           <button 
...
//             </div>
//             <p className="text-white font-medium">Processing Your Investment...</p>
//             <p className="text-sm text-white/60 mt-2">Preparing your earnings journey</p>
//           </div>
//         ) : (
//           <>
//             {/* Investment Tiers */}
...
//                 <h4 className="text-sm font-medium text-white/80">Choose Your Power Level</h4>
//                 <div className="text-xs text-blue-400">Bonus rewards unlocked!</div>
//               </div>
//               <div className="grid grid-cols-3 gap-2">
//                 {[
//                   { amount: 1, label: 'Starter', bonus: '+1% ROI' },
//                   { amount: 10, label: 'Builder', bonus: '+2% ROI' },
//                   { amount: 50, label: 'Investor', bonus: '+3% ROI' },
//                   { amount: 100, label: 'Whale', bonus: '+5% ROI' },
//                   { amount: 500, label: 'Legend', bonus: '+10% ROI' },
//                   { amount: 1000, label: 'NOVA GOD', bonus: '+15% ROI' },
//                 ].map(({ amount, label, bonus }) => (
//                   <button
//                     key={amount}
//                     onClick={() => {
...
//                     <div className="text-center">
//                       <div className="font-bold text-white mb-1">{amount} TON</div>
//                       <div className="text-[10px] text-blue-400 font-medium">{label}</div>
//                       <div className="text-[9px] text-green-400 mt-1">{bonus}</div>
//                     </div>
//                   </button>
//                 ))}
//               </div>
...
//                       className="h-full bg-gradient-to-r from-blue-500 to-purple-500 transition-all duration-500"
//                       style={{ 
//                         width: `${Math.min((parseFloat(customAmount) / 1000) * 100, 100)}%`,
//                       }}
//                     />
//                   </div>
//                   <div className="flex justify-between text-xs">
//                     <span className="text-white/60">Progress to NOVA GOD</span>
//                     <span className="text-blue-400 font-medium">
//                       {Math.min((parseFloat(customAmount) / 1000) * 100, 100).toFixed(1)}%
//                     </span>
//                   </div>
//                 </div>
//               )}
...
//               <div className="bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-lg p-4 border border-blue-500/20 space-y-4 mb-6">
//                 <h4 className="text-sm font-medium text-white/80 mb-3">Your Rewards Preview</h4>
                
//                 <div className="space-y-3">
//                   {/* Daily Earnings with Animation */}
//                   <div className="flex items-center justify-between">
//                     <span className="text-sm text-white/60">Daily Earnings</span>
//                     <div className="flex items-center gap-2">
//                       <div className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></div>
//                       <span className="text-sm font-medium text-green-400">
//                         +{(parseFloat(customAmount) * currentROI).toFixed(6)} TON
//                       </span>
//                     </div>
//                   </div>
...
//                   {/* Monthly Projection */}
//                   <div className="flex items-center justify-between">
//                     <span className="text-sm text-white/60">Monthly Estimate</span>
//                     <span className="text-sm font-medium text-blue-400">
//                       +{(parseFloat(customAmount) * currentROI * 30).toFixed(2)} TON
//                     </span>
//                   </div>
...
//                     <div className="flex items-center justify-between">
//                       <span className="text-sm text-white/60">100-Day Return</span>
...
//                   : 'bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white transform hover:scale-[1.02] active:scale-[0.98]'
//               }`}
//             >
//               {user?.balance && user.balance > 0 
//                 ? `Power Up with ${customAmount ? `${parseFloat(customAmount).toFixed(2)} TON` : 'TON'}`
//                 : `Start Earning with ${customAmount ? `${parseFloat(customAmount).toFixed(2)} TON` : 'TON'}`}
//             </button>

//             {/* Gamified Info Footer */}
//             <div className="mt-4 space-y-2">
//               <div className="flex items-center gap-2 text-xs text-white/40">
//                 <svg className="w-4 h-4 text-yellow-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
//                 </svg>
//                 <span>Stake more to unlock higher ROI tiers!</span>
//               </div>
//               <div className="flex items-center gap-2 text-xs text-white/40">
//                 <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
//                   <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
//                 </svg>
//                 <span>Earn NOVA tokens with every stake!</span>
//               </div>
//             </div>
//           </>
//         )}
