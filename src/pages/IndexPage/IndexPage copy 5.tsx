...
//                   <StatsCard
//                     title="Earnings"
//                     value={`${(loadTotalEarned() + earningState.currentEarnings).toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2})} TON`}
...
//       {/* Level */}
//       <div className="text-xs text-white/60">
//         Level {Math.floor((user?.total_sbt ?? 0) / 100) + 1} • {Math.floor(((user?.total_sbt ?? 0) % 100) * 100) / 100}% to next level
//       </div>
//     </div>
//   </div>
// </div>
