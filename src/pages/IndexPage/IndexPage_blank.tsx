...
//               <span className="text-sm text-white/60">Mining Power</span>
//               <span className="text-sm text-blue-400">
//                 {(earningState.baseEarningRate * 86400).toFixed(6)} NOVA/day
//               </span>
//             </div>
//             {/* Power Progress Bar */}
...
//                 style={{ width: `${Math.min((earningState.baseEarningRate * 100000), 100)}%` }}
//               />
//             </div>
//           </div>
...
//               ≈ ${((user?.balance || 0) * tonPrice).toFixed(2)}
//             </div>
//           </div>
...
//           <div className="bg-zinc-900/50 rounded-lg p-4">
//             <div className="flex items-center justify-between">
//               <span className="text-sm text-white/60">NOVA Power</span>
//               <span className="text-sm text-purple-400">
//                 {(user?.total_sbt || 0).toFixed(2)}
//               </span>
//             </div>
//           </div>
//         </div>
